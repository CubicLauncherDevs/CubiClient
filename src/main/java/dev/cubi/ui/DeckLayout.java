...
public final class DeckLayout {
    ...
    public static final Rect[] CARDS = new Rect[3], TOGGLES = new Rect[3], SETTINGS = new Rect[3], ACCENTS = new Rect[4];
    ...
    static {
        for (int i = 0; i < 3; i++) {
            int x = 20 + i * 180;
            CARDS[i] = new Rect(x, 148, 160, 164);
            TOGGLES[i] = new Rect(x + 12, 278, 96, 23);
            SETTINGS[i] = new Rect(x + 116, 278, 32, 23);
        }
